// Inline SVG icons (replaces the external Font Awesome stylesheet).
// Each icon scales with the current font-size (width/height = 1em) and
// inherits color via `fill="currentColor"`, mirroring how the old FA
// glyphs behaved. Decorative by default (aria-hidden).
import React from 'react';

const Icon = ({ viewBox, path, ...props }) => (
  <svg
    viewBox={viewBox}
    width="1em"
    height="1em"
...
export const YouTubeIcon = (props) => (
  <Icon
    viewBox="0 0 576 512"
    path="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.219 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.219 448 288 448 288 448s170.781 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"
    {...props}
  />
);
